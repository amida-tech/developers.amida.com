window.Modernizr = function(e, t, n) {
	...
	var i, a, c, l = "2.6.2", s = {}, u = !0, d = t.documentElement, f = "modernizr", p = t.createElement(f), m = p.style, h = {}.toString, v = " -webkit- -moz- -o- -ms- ".split(" "), y = {
		svg : "http://www.w3.org/2000/svg"
	}, g = {}, E = [], b = E.slice, S = function(e, n, r, o) {
		var i, a, c, l, s = t.createElement("div"), u = t.body, p = u || t.createElement("body");
		if (parseInt(r, 10))
			for (; r--; )
	...
	c = o(w, "undefined") || o(w.call, "undefined") ? function(e, t) {
		...
		var n = b.call(arguments, 1), r = function() {
			if (this instanceof r) {
				...
				var i = new o, a = t.apply(i, n.concat(b.call(arguments)));
	...
	for (var j in g)c(g, j) && ( a = j.toLowerCase(), s[a] = g[j](), E.push((s[a] ? "" : "no-") + a));
	return s.addTest = function(e, t) {
		...
		function c(e, t) {
			...
			}, e.createDocumentFragment = Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+r().join().replace(/\w+/g,function(e){return t.createElem(e),t.frag.createElement(e),'c("'+e+'")'})+");return n}")(y, t.frag)
		}
		...
		var s, u, d = e.html5 || {}, f = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, p = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, m = "_html5shiv", h = 0, v = {};
		! function() {
			try {
	...
	function l(e, n, r, o, i, l, s) {
		...
		var s = s || f.errorTimeout, d = t.createElement(e), p = 0, v = 0, E = {
			t : r,
			s : n,
			e : i,
			a : l,
	...
	var d, f, p = t.documentElement, m = e.setTimeout, h = t.getElementsByTagName("script")[0], v = {}.toString, y = [], g = 0, E = "MozAppearance" in p.style, b = E && !!t.createRange().compareNode, S = b ? p : h.parentNode, p = e.opera && "[object Opera]" == v.call(e.opera), p = !!t.attachEvent && !p, C = E ? "object" : p ? "script" : "img", w = p ? "script" : C, j = Array.isArray ||
	function(e) {
	...
	f = function(e) {
		function t(e) {
			var t, n, r, e = e.split("!"), o = N.length, i = e.pop(), a = e.length, i = {
				url : i,
				origUrl : i,
				prefixes : e
			};
		...
		function c(e, t) {
			...
			var c, l, s = !!e.test, u = e.load || e.both, d = e.callback || i, f = d, p = e.complete || i;
